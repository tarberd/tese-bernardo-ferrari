...
After construction of the Syntax tree, Ekitai's front-end translates
\pagebreak

\section{The Ekitai's type system}

Ekitai's type-checker embodies a sophisticated blend of practicality and rigorous theory, aiming to provide developers with a powerful yet intuitive type system.
Drawing from the comprehensive theoretical foundation detailed in \cref{ch:refinement_types}, this type system is an implementation of a refinement types for a subset of lambda calculus.
