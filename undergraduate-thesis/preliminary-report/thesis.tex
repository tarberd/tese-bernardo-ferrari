...
We decided to use an automatic lexer generator since we found no advantage in building one by hand and the automatic parser generator used was capable of lexing all token patterns in the specification.
...
\begin{figure}[ht]
  \begin{alignat*}{2}
    ...
    \bnfmore{
      \bnfvar{Type} \bnfter{,} \bnfor{\bnfvar{Type}}
    } \\
    \bnfprod{FnDef}{
      \bnfter{fn}
      \bnfvar{Name}
    ...
    \bnfmore{
      \bnfvar{Param} \bnfter{,} \bnfor{\bnfvar{Param}}
    } \\
    \bnfprod{Param}{
      \bnfvar{Name}
      \bnfter{:}
