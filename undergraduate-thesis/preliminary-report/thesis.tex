...
\begin{figure}[ht]
  \begin{minipage}{\textwidth}
    \begin{align*}
       & \evalr{if true then $\code{term}_1$ else $\code{term}_2$}{$\code{term}_1$} \tag{Eval-IfTrue}   \\
       & \evalr{if false then $\code{term}_1$ else $\code{term}_2$}{$\code{term}_2$} \tag{Eval-IfFalse}
    \end{align*}
    \begin{equation*}
      \inferrule{
    ...
    \end{equation*}
    \begin{equation*}
      \evalr{pred succ nvalue}{nvalue} \tag{Eval-PredSucc}
    \end{equation*}
    \begin{equation*}
      \inferrule{
        \evalr{$\code{term}_1$}{$\code{term}_2$}
    ...
    \end{equation*}
    \begin{equation*}
      \evalr{iszero 0}{true} \tag{Eval-IszeroZero}
    \end{equation*}
    \begin{equation*}
      \inferrule{
        \evalr{$\code{term}_1$}{$\code{term}_2$}
  ...
  \end{minipage}
  \caption{
    The evaluation relations for the operational semantics of the abstract syntax~\eqref{eq:sample_term_ast} with values defined by~\eqref{eq:sample_ast_values}. Adapted from \textcite{sipser2012introduction}.
