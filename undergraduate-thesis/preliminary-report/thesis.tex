...
% TODO: Add references
% \bibitem{Cytron:1991:ESA:115372.115320}
% Cytron, R., Ferrante, J., Rosen, B. K., Wegman, M. N., \& Zadeck, F. K. (1991).
% \textit{Efficiently computing static single assignment form and the control dependence graph.}
...
This IR serves as a three-address code, meticulously designed to delineate programs in a format that is both low-level and independent of any particular platform~\cite{lee2018reconciling}.
...
The LLVM framework equips developers with a battery of optimization passes, tailored to refine the IR and enhance the efficiency of the resultant code~\cite{lee2018reconciling}.
These optimization techniques span across various strategies, such as:
