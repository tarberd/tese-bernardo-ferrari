...
We have already described how to evaluate a concrete parse tree into an abstract syntax tree in Section~\ref{sec:syntax:subsec:abstrac_syntax_trees}, and, the process of creating tree traversals algorithms in order to perform tree transformations continues into evaluating an AST into an IR suitable for code optimization and target code generation.
